...
;(function( $, window, document, undefined ) {
    ...
    return this.each( function() {
      ...
      $reset.on('click', function( e ) {
        ...
        if ( CSF.vars.is_confirm ) {
          ...
          window.wp.ajax.post('mcsf-reset', {
      ...
      $import.on('click', function( e ) {
        ...
        if ( CSF.vars.is_confirm ) {
          ...
          window.wp.ajax.post( 'mcsf-import', {
  ...
  $.fn.csf_field_group = function() {
    return this.each( function() {
      ...
      $wrapper.sortable({
        axis: 'y',
        handle: '.csf-cloneable-title:not(.nosort),.csf-cloneable-sort:not(.nosort)',
        helper: 'original',
        cursor: 'move',
    ...
    return this.each( function() {
      ...
      $this.on('click', '.csf-icon-add', function( e ) {
        ...
        if ( !CSF.vars.icon_modal_loaded ) {
          ...
          window.wp.ajax.post( 'mcsf-get-icons', {
