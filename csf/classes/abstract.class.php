 ...
 *
 */
if ( ! class_exists( 'MCSF_Abstract' ) ) {
  abstract class MCSF_Abstract {
    ...
    public function __construct() {
      ...
      if ( ! empty( $this->args['output_css'] ) || ! empty( $this->args['enqueue_webfont'] ) ) {
        ...
        MCSF::$css = apply_filters( "csf_{$this->unique}_output_css", MCSF::$css, $this );
      }
    ...
    public function recursive_output_css( $fields = array(), $combine_field = array() ) {
      ...
      if ( ! empty( $fields ) ) {
        ...
        foreach ( $fields as $field ) {
          ...
          $field_class  = 'MCSF_Field_' . $field_type;
