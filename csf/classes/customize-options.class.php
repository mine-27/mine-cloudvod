 ...
 *
 */
if( ! class_exists( 'MCSF_Customize_Options' ) ) {
  class MCSF_Customize_Options extends MCSF_Abstract {
    ...
    public function add_customize_options( $wp_customize ) {
      ...
      if( ! class_exists( 'WP_Customize_Panel_MCSF' ) ) {
        MCSF::include_plugin_file( 'functions/customize.php'  );
      }
      ...
      if( ! empty( $this->sections ) ) {
        ...
        foreach( $sections as $section ) {
          ...
          if( ! empty( $section['subs'] ) ) {
            ...
            $wp_customize->add_panel( new WP_Customize_Panel_MCSF( $wp_customize, $panel_id, array(
              'title'       => $section['title'],
    ...
    public function add_section( $wp_customize, $section_id, $section_args, $panel_id ) {
      ...
      $wp_customize->add_section( new WP_Customize_Section_MCSF( $wp_customize, $section_id, array(
      ...
      if( ! empty( $section_args['fields'] ) ) {
        ...
        foreach( $section_args['fields'] as $field ) {
          ...
          $wp_customize->add_control( new WP_Customize_Control_MCSF( $wp_customize, $setting_id,
