 ...
 *
 */
if( ! class_exists( 'MCSF_Profile_Options' ) ) {
  class MCSF_Profile_Options extends MCSF_Abstract{
      ...
      foreach( $this->sections as $section ) {
        ...
        if( ! empty( $section['fields'] ) ) {
          foreach( $section['fields'] as $field ) {
            ...
            MCSF::field( $field, $this->get_meta_value( $profile_id, $field ), $this->unique, 'profile' );
