 ...
 *
 */
if( ! class_exists( 'MCSF_Taxonomy_Options' ) ) {
  class MCSF_Taxonomy_Options extends MCSF_Abstract{
        ...
        if( $taxonomy === $this->taxonomy ) {
          ...
          if( ! empty( $section['fields'] ) ) {
            foreach( $section['fields'] as $field ) {
              ...
              MCSF::field( $field, $this->get_meta_value( $term_id, $field ), $this->unique, 'taxonomy' );
