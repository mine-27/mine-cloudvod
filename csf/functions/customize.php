 ...
 *
 */
if ( ! class_exists( 'WP_Customize_Panel_MCSF' ) && class_exists( 'WP_Customize_Panel' ) ) {
  class WP_Customize_Panel_MCSF extends WP_Customize_Panel {
    public $type = 'csf';
  }
}
 ...
 *
 */
if ( ! class_exists( 'WP_Customize_Section_MCSF' ) && class_exists( 'WP_Customize_Section' ) ) {
  class WP_Customize_Section_MCSF extends WP_Customize_Section {
    public $type = 'csf';
  }
}
 ...
 *
 */
if ( ! class_exists( 'WP_Customize_Control_MCSF' ) && class_exists( 'WP_Customize_Control' ) ) {
  class WP_Customize_Control_MCSF extends WP_Customize_Control {
