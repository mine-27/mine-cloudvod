...
if ( ! class_exists( 'WP_Customize_Control_CSF' ) && class_exists( 'WP_Customize_Control' ) ) {
  class WP_Customize_Control_CSF extends WP_Customize_Control {
    ...
    public function render() {
      ...
      echo '<li id="'. esc_attr( $id ) .'" class="'. esc_attr( $class ) .'"'. $depend_escaped .'>';
    ...
    public function render_field_content() {
      ...
      $atts_escaped       = ( $is_complex || $custom ) ? ' data-unique-id="'. esc_attr( $this->unique ) .'" data-option-id="'. esc_attr( $field_id ) .'"' : '';
      ...
      echo '<div class="csf-customize-field'. esc_attr( $class ) .'"'. $atts_escaped .'>';

      MCSF::field( $this->field, $this->value(), $this->unique, 'customize' );
