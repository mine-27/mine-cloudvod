 ...
 *
 */
if ( ! class_exists( 'MCSF_Field_switcher' ) ) {
  class MCSF_Field_switcher extends MCSF_Fields {
    ...
    public function render() {
      ...
      $text_on    = ( ! empty( $this->field['text_on'] ) ) ? $this->field['text_on'] : esc_html__( 'On', 'mine-cloudvod' );
      $text_off   = ( ! empty( $this->field['text_off'] ) ) ? $this->field['text_off'] : esc_html__( 'Off', 'mine-cloudvod' );
