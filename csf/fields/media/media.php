 ...
 *
 */
if ( ! class_exists( 'MCSF_Field_media' ) ) {
  class MCSF_Field_media extends MCSF_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args( $this->field, array(
        ...
        'preview_height' => '',
        'library'        => array(),
        'button_title'   => esc_html__( 'Upload', 'mine-cloudvod' ),
        'remove_title'   => esc_html__( 'Remove', 'mine-cloudvod' ),
      ...
      $placeholder = ( empty( $this->field['placeholder'] ) ) ? ' placeholder="'.  esc_html__( 'Not selected', 'mine-cloudvod' ) .'"' : '';
