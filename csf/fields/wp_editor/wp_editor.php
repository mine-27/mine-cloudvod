 ...
 *
 */
if ( ! class_exists( 'MCSF_Field_wp_editor' ) ) {
  class MCSF_Field_wp_editor extends MCSF_Fields {
    ...
    public function render() {
      ...
      $editor_height_escaped = ( ! empty( $args['height'] ) ) ? ' style="height:'. esc_attr( $args['height'] ) .';"' : '';
      ...
      echo '<textarea name="'. esc_attr( $this->field_name() ) .'"'. $this->field_attributes( $attributes ) . $editor_height_escaped .'>'. $this->value .'</textarea>';
