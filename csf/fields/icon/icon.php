 ...
 *
 */
if ( ! class_exists( 'MCSF_Field_icon' ) ) {
  class MCSF_Field_icon extends MCSF_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args( $this->field, array(
        'button_title' => esc_html__( 'Add Icon', 'mine-cloudvod' ),
        'remove_title' => esc_html__( 'Remove Icon', 'mine-cloudvod' ),
      ) );
    ...
    public function enqueue() {
      add_action( 'admin_footer', array( 'MCSF_Field_icon', 'add_footer_modal_icon' ) );
      add_action( 'customize_controls_print_footer_scripts', array( 'MCSF_Field_icon', 'add_footer_modal_icon' ) );
    }
          ...
          <div class="csf-modal-table-cell">
            ...
            <div class="csf-modal-inner">
              <div class="csf-modal-title">
                <?php esc_html_e( 'Add Icon', 'mine-cloudvod' ); ?>
                <div class="csf-modal-close csf-icon-close"></div>
              </div>
              <div class="csf-modal-header">
                <input type="text" placeholder="<?php esc_html_e( 'Search...', 'mine-cloudvod' ); ?>" class="csf-icon-search" />
              </div>
