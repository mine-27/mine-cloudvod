 ...
 *
 */
if ( ! class_exists( 'MCSF_Field_datetime' ) ) {
  class MCSF_Field_datetime extends MCSF_Fields {
    ...
    public function render() {
      ...
      if ( ! empty( $this->field['from_to'] ) ) {
        ...
        $args = wp_parse_args( $this->field, array(
          'text_from' => esc_html__( 'From', 'mine-cloudvod' ),
          'text_to'   => esc_html__( 'To', 'mine-cloudvod' ),
        ) );
