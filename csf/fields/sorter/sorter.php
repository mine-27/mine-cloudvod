 ...
 *
 */
if ( ! class_exists( 'MCSF_Field_sorter' ) ) {
  class MCSF_Field_sorter extends MCSF_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args( $this->field, array(
        'disabled'       => true,
        'enabled_title'  => esc_html__( 'Enabled', 'mine-cloudvod' ),
        'disabled_title' => esc_html__( 'Disabled', 'mine-cloudvod' ),
      ) );
