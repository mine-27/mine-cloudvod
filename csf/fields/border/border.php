 ...
 *
 */
if ( ! class_exists( 'MCSF_Field_border' ) ) {
  class MCSF_Field_border extends MCSF_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args( $this->field, array(
        ...
        'top_placeholder'    => esc_html__( 'top', 'mine-cloudvod' ),
        'right_placeholder'  => esc_html__( 'right', 'mine-cloudvod' ),
        'bottom_placeholder' => esc_html__( 'bottom', 'mine-cloudvod' ),
        'left_placeholder'   => esc_html__( 'left', 'mine-cloudvod' ),
        'all_placeholder'    => esc_html__( 'all', 'mine-cloudvod' ),
        'top'                => true,
        'left'               => true,
        'bottom'             => true,
        'right'              => true,
      ...
      $border_props = array(
        'solid'     => esc_html__( 'Solid', 'mine-cloudvod' ),
        'dashed'    => esc_html__( 'Dashed', 'mine-cloudvod' ),
        'dotted'    => esc_html__( 'Dotted', 'mine-cloudvod' ),
        'double'    => esc_html__( 'Double', 'mine-cloudvod' ),
        'inset'     => esc_html__( 'Inset', 'mine-cloudvod' ),
        'outset'    => esc_html__( 'Outset', 'mine-cloudvod' ),
        'groove'    => esc_html__( 'Groove', 'mine-cloudvod' ),
        'ridge'     => esc_html__( 'ridge', 'mine-cloudvod' ),
