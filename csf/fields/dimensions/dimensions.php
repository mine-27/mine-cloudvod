 ...
 *
 */
if ( ! class_exists( 'MCSF_Field_dimensions' ) ) {
  class MCSF_Field_dimensions extends MCSF_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args( $this->field, array(
        ...
        'width_placeholder'  => esc_html__( 'width', 'mine-cloudvod' ),
        'height_placeholder' => esc_html__( 'height', 'mine-cloudvod' ),
        'width'              => true,
        'height'             => true,
        'unit'               => true,
        'show_units'         => true,
