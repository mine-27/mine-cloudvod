 ...
 *
 */
if ( ! class_exists( 'MCSF_Field_group' ) ) {
  class MCSF_Field_group extends MCSF_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args( $this->field, array(
        ...
        'min'                       => 0,
        'fields'                    => array(),
        'button_title'              => esc_html__( 'Add New', 'mine-cloudvod' ),
      ...
      if ( preg_match( '/'. preg_quote( '['. $this->field['id'] .']' ) .'/', $this->unique ) ) {
        ...
        echo '<div class="csf-notice csf-notice-danger">'. esc_html__( 'Error: Field ID conflict.', 'mine-cloudvod' ) .'</div>';
        ...
        echo '<div class="csf-cloneable-item csf-cloneable-hidden" data-depend-id="'. esc_attr( $this->field['id'] ) .'">';
          ...
          echo '<i class="csf-cloneable-remove csf-confirm fas fa-times" data-confirm="'. esc_html__( 'Are you sure to delete this item?', 'mine-cloudvod' ) .'"></i>';
          echo '</div>';
          ...
          foreach ( $this->field['fields'] as $field ) {
            ...
            MCSF::field( $field, $field_default, '___'. $field_unique, 'field/group' );
          ...
          foreach ( $this->value as $value ) {
            ...
            echo '<div class="csf-cloneable-item">';
              ...
              foreach ( $this->field['fields'] as $field ) {
                ...
                MCSF::field( $field, $field_value, $field_unique, 'field/group' );
        ...
        echo '<div class="csf-cloneable-alert csf-cloneable-max">'. esc_html__( 'You cannot add more.', 'mine-cloudvod' ) .'</div>';
        echo '<div class="csf-cloneable-alert csf-cloneable-min">'. esc_html__( 'You cannot remove more.', 'mine-cloudvod' ) .'</div>';
